                        ...
                        <div class="form-wrap shadow">
                            <form method="POST" enctype="multipart/form-data">
                                <div class="form-intro">
                                    <b><img src="./assets/favicon.png" alt="favicon"></b>
                    ...
                    <div class="modal-fader">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                ...
                                <form class="quickSignup" method="POST" action="./handlers/user/handleAccounts/serverAuthInit" enctype="multipart/form-data" >
            ...
            $(function(){
                let phoneNumber = init.getNumber(intlTelInputUtils.numberFormat.E164),
                    ...
                    if((phoneNumber!="") && (secretCode!="")){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "./handlers/user/handleAccounts/serverAuthInit",
                            async: true,
                            cache:false,
                            data:{'data':data},
                            beforeSend:function(){
            ...
            $(function(){
                let phoneNumberUsage = sinit.getNumber(intlTelInputUtils.numberFormat.E164),
                    ...
                    if((phoneNumberUsage!="") && (secretCodeUsage!="")){
                        $.ajax({
                            type: "POST",
                            url: "./handlers/user/handleAccounts/serverAuthUsage",
                            async: true,
                            cache:false,
                            data:{'data':{
        ...
        function serverAuthRecoverAccount(){
            $(function(){
                    ...
                    if((email!="")){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "./handlers/user/handleAccounts/mw_forgot_password",
                            async: true,
                            cache:false,
                            data:{'data':data},
                            beforeSend:function(){
