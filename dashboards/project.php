                    ...
                    <div class="row">
                        ...
                        <section class="col-sm-12 col-md-9 col-lg-9 col-xl-9 section">
                            ...
                            <div class="projectioptions">
                                <a href="report?<?php echo $params.'&&gallery=1';?>" class="btn btn-dark btn-sm">Print <i class="fa fa-print"></i></a>
                                <a href="pictures?<?php echo $params.'&&gallery=1';?>" class="btn btn-dark btn-sm">Pictures <i class="fa fa-image"></i></a>
                                <a href="progress?<?php echo $params;?>" class="btn btn-dark btn-sm">Progress <i class="fa fa-snowflake"></i></a>
                                <a href="invite?<?php echo $params.'&&gallery=1';?>" class="btn btn-dark btn-sm">Teamwork <i class="fa fa-users"></i></a>
                                <a href="discuss?<?php echo $params.'&&gallery=1';?>" class="btn btn-dark btn-sm">Discuss <i class="fa fa-laptop"></i></a>
                                <a href="share?<?php echo $params.'&&gallery=1';?>" class="btn btn-dark btn-sm">Send <i class="fa fa-paper-plane"></i></a>
                            </div>
