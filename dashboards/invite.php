                        ...
                        <section class="col-sm-12 col-md-9 col-lg-9 col-xl-9 section">
                            ...
                            <div class="form-wrap">
                                ...
                                <form class="invitation_form">
                                    ...
                                    <br>
                                    <div>
                                        <button type="button" class="btn btn-sm btn-dark submit-btn invite-btn" id="migrateAdd">Make Team Members</button>
                                    </div>
                                </form>
                            </div>
                        </section>
    ...
    <script>
            ...
            if(checkedCount>=1){
                let formData = new FormData(),
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '../handlers/user/handleAdvert/mw_project_push_invite',
                        processData: false,
                        contentType: false,
                        async: true,
                        data:formData,
