                                ...
                                <form>
                                    ...
                                    <div class="form-grouped">
                                        <div class="form-group-even">
                                            <input type="text" name="name" id="name" placeholder="Describe Progress ....." />
                                        ...
                                        <div class="song-files">
                                            ...
                                            <div class="sub-form-group">
                                                <button type="button" 
                                                        ...
                                                        id="migrateAdd">
                                                        <strong>
                                                           <i class="fa fa-paper-plane"></i> INTERATE PROGRESS
                                                        </strong> 
                                                </button>
                                            </div>
                                        </div>
    ...
    <script>
        $("#migrateAdd").click(function(evt){
            ...
            let formData = new FormData(),
                ...
                $.ajax({
                    type: 'POST',
                    url: '../handlers/user/handleAdvert/mw_project_push_progress',
                    processData: false,
                    contentType: false,
                    async: true,
                    data:formData,
