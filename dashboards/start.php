...
<html>
<head>
    <?php $AdminiUXTemplate->headers('Initialize...');?>
</head>
<body>
                            ...
                            <div class="form-wrap">
                                ...
                                <form>
                                    <div class="form-grouped">
                                        <label for="form-section" class="form-section"></label>
                                        <div class="form-group-even">
                                            <input type="text" name="name" id="name" placeholder="Full Name..." />
                                            <input type="text" name="desc" id="desc" placeholder="Full Description..."/>
                                            <input type="text" name="director" id="director" placeholder="Supervisor Fullname ..." />
                                        </div>
                                    </div>
                                    <div class="form-grouped">
                                        <label for="form-section" class="form-section">Finishing Date</label>
                                        <div class="form-group-even">
                                        ...
                                        <div class="song-files">
                                            ...
                                            <div class="sub-form-group">
                                                <button type="button" 
                                                        ...
                                                        id="migrateAdd">
                                                        <strong>
                                                           <i class="fa fa-paper-plane"></i> RESGISTER PROJECT
                                                        </strong> 
                                                </button>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $("#migrateAdd").click(function(evt){
            ...
            let formData = new FormData(),
                ...
                $.ajax({
                    type: 'POST',
                    url: '../handlers/user/handleAdvert/mw_project_push',
                    processData: false,
                    contentType: false,
                    async: true,
                    data:formData,
