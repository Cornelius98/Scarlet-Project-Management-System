        ...
        echo '<nav class="navbar navbar-expand-sm navbar-dark">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="home" style="text-transform:uppercase;">
                        <span class="m-name">
                            <img src="../assets/favicon.png" class="nav-icon-for-project" alt="favicon"> 
                        </span>
                    </a>
                    <div id="navbarCollapse" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"><a href="start" class="nav-link">INITIALIZE</a></li>
                            <li class="nav-item"><a href="projects" class="nav-link">PROJECTS</a></li>
                            <li class="nav-item"><a href="discussed" class="nav-link">FORUM</a></li>
                            <li class="nav-item"><a href="timeline" class="nav-link">USER</a></li>
                            <li class="nav-item"><a href="password" class="nav-link">SECURITY</a></li>
                        </ul>
                    </div>
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                        <ul class="navbar-nav ml-auto mt-2 mt-lg-0"></ul>
                    </div>
                    <a href="logout" class="sign-out-circle shadow"><i class="fa fa-arrow-right"></i></a>
                </div>
            </nav>';
    }
        ...
        echo '<div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="start">Initialize</a>
                    </li>
                    <li>
                        <i class="fa fa-recycle"></i>
                        <a href="projects">Started Projects</a>
                    </li>
                    <li>
                ...
                <br>
                <hr>
                <div class="user-details user-bottom-details">
                    <h5> 
                        <small>'.$_SESSION['aSessn']['aCode'].'</small>
                        <br>
                        '.$_SESSION['aSessn']['aName'].'
                        <br>
                        <br>
                        <a href="logout" class="btn btn-sm btn-danger btn-block" style="width:100%;">Logout</a>
                    </h5>
                </div>
            </div>';
    }
                    ...
                    if(($page<=$num_pages) && ($page>=1)){
                        ...
                        echo '<div class="pagination-items">
                            ...
                            <div class="pagination-pages">
                                <div class="count-pages">&nbsp; Total | &nbsp;<strong>Page '.$num_pages.'</strong></div>
                            </div>
                    </div>';
                }
        }
                    ...
                    echo '<div class="advertised shadow">
                            ...
                            <div class="advertised-menu">';
                                ...
                                elseif(($product["mute"]==1) && $product["adr_id"]!=$_SESSION["aSessn"]["aSeck"])
                                    ...
                                    echo '<a href="project?pipe='.$_SESSION["aSessn"]["aSeck"].'&&pjr='.$product["pj_id"].'">Check Now</a>';
                    ...
                    echo '<div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 shadow gallery-card" style="height:270px;padding:0;">
                            ...
                            <div class="gallery-details">
                                <a href="'.str_ireplace("./","../",$product["store_url"])."/".$product["pc_name"].'" download>
                                    ...
                                    <a href="../handlers/user/handleAdvert/mw_project_gallery_delete?'.$params.'&&fs_name='.$product["pc_name"].'&&fs_id='.$product["pc_id"].'" class="f-download">
        ...
        $html = '<div style="color:#0000;background-color:white;font-family:arial;">
                <div style="color:#0000">
                    <div style="color:#0000;border-bottom:1px solid rgb(67,103,132);line-height:14px;">
                        <br/>
                        <small style="color:#0000;text-align:right;font-size:25px;text-transform:uppercase;"><b>Project Manager Report</b></small>
                        <br/>
                        <br/>
                        <small style="text-align:right;">Considered Official</small><br/>
                        <br/>
                        <br/>
                    </div>
                    <div>
    ...
    public function vw_invitees($productsContainer){
        if(is_array($productsContainer) && !empty($productsContainer)){
            foreach($productsContainer As $invitess){
                echo '
                <div class="advertised shadow">
                    <div class="advertised-details">
                        <h5>'.$invitess["fname"].' '.$invitess["sname"].'</h5>';
                        echo '<small class="pj-desc">Make Team Member. Choose below.</small>';
                    echo '</div>
                    <div class="advertised-menu">';
                       echo '<input type="checkbox" name="invitee[]" id="invitee" value="'.$invitess["adr_id"].'">';
                    echo '</div>
                </div>';
            }
        }else {
            ...
            foreach($productsContainer As $share){
                echo '<div class="tab share-tab">
                        ...
                        <footer class="tab-footer">
                            <a onclick="unicastPlatformShare('.$_SESSION["aSessn"]["aSeck"].','.$share["shc_id"].','.$pj_id.');" target="_blank" href="'.$share["official_link"].'" ><button class="btn btn-sm btn-outline-danger">Go <i class="fa fa-arrow-right"></i></button></a>
                        </footer>
                </div>';
            }
        }else {
